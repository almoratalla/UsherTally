...
const Dashboard = () => {
  ...
  const debouncedAddSection = debounce(async (newId: number, name: string) => {
  ...
  const debouncedRenameSection = debounce(async (id: number, name: string) => {
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      {isLoggedIn ? (
        <div className="flex flex-col items-center py-40 min-h-screen bg-gray-100">
          <h1 className="text-4xl font-bold mb-4">UsherTally Dashboard</h1>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex space-x-4">
                    <button
                      onClick={() => increment(section.id)}
                      className="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition"
                    >
                      Add
                    </button>
                    <button
                      onClick={() => decrement(section.id)}
                    ...
                    >
                      {isEditing[section.id] ? "Save" : "Edit"}
                    </button>
                  </div>
                </div>
              );
          ...
          <section className="py-20 bg-gray-100">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="text-center">
                  <p className="text-gray-600">
                    "Secure authentication gives us peace of mind knowing our
                    data is safe."
                  </p>
                  <div className="mt-4 flex justify-center">
                    <Image
