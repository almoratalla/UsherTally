...
export const Header = () => {
  ...
  return (
    <header className="bg-white dark:bg-black sticky top-0 w-full border-b px-4 sm:px-6 2xl:px-0 z-50">
      <div className="max-w-7xl mx-auto py-6 flex justify-between items-center">
        <div className="text-2xl font-bold text-gray-900 dark:text-gray-100 flex flex-row gap-4 sm:gap-8 items-center">
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent side="right" className="w-[300px] sm:w-[400px]">
              <nav className="flex flex-col space-y-4">
                <Link
                  href={"/profile"}
                  className={cn("text-sm transition-colors  font-semibold")}
                >
