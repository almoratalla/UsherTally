  ...
  return (
    <section className="flex flex-col items-start gap-4 w-full">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center w-full gap-4">
        <h1 className="text-3xl sm:text-4xl font-bold">Counter Dashboard</h1>
        <div className="flex items-center space-x-2">
          <Switch
            ...
            id="edit-mode"
          />
          <Label htmlFor="edit-mode" className="text-sm sm:text-base">
            {isEditMode ? (
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center w-full gap-4">
          ...
          {sections.length > 0 && (
            <div className="w-full sm:w-auto">
              ...
              >
                <RotateCcw className="mr-2 h-4 w-4" /> Reset All Counts
              </Button>
            </div>
          )}
        </div>
          ...
          >
            <div className="flex flex-col sm:flex-row gap-4 w-full">
              <FloatingLabelInput
                ...
                className={cn(
                  "w-full",
                  errors.newSectionTitle ? "border-red-500 border-2" : "",
                )}
              />
              ...
              <FloatingLabelInput
                ...
                className={cn(
                  "w-full",
                  errors.newSectionCapacity ? "border-red-500 border-2" : "",
                )}
              />
              <Button
                type="submit"
